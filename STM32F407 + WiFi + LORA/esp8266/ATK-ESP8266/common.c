...
const u8* wifista_ssid="AlbusInk";			//路由器SSID号
const u8* wifista_encryption="wpawpa2_aes";	//wpa/wpa2 aes加密方式
const u8* wifista_password="AlbusInk"; 	//连接密码
...
u8 atk_8266_ip_set(u8* title,u8* mode,u8* port,u8* ip) 
{
	...
	atk_8266_load_keyboard(0,180);			//显示键盘 --使用LCD屏的画笔功能画出相应的框并填入字符
	POINT_COLOR=BLUE;
